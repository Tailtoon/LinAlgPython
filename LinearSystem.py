...
if __name__ == "__main__":
    ...
    print(Matrix([[1], [0], [-1], [0], [0]], 5, 1))
    print("A * базисное решение")
    print(a * Matrix([[1], [0], [-1], [0], [0]], 5, 1))
    print("Матрица B")
    print(b)
    print("Фундаменатальные решения")
    print(Matrix([[-5], [0], [-1], [0], [2]], 5, 1))
    print(Matrix([[9], [-3], [7], [2], [0]], 5, 1))
    print("A * фундаментальное решение при c1")
    print(a * Matrix([[-5], [0], [-1], [0], [2]], 5, 1))
    print("A * фундаментальное решение при c2")
    print(a * Matrix([[9], [-3], [7], [2], [0]], 5, 1))
